...
class TrelloFacadeTest {
    ...
    void shouldCreateTrelloCard() {
        // Given
        TrelloCardDto trelloCardDto = new TrelloCardDto("jeden", "dwa", "trzy", "cztery");
       CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("1", "2", "3");
    ...
    void shouldValidate() {
        // Given
        TrelloCard trelloCard = new TrelloCard("Jeden", "dwa", "trzy", "cztery");
        List<TrelloList> mappedTrelloLists =
                List.of(new TrelloList("1", "1_list", false));

        List<TrelloBoard> mappedTrelloBoards =
                List.of(new TrelloBoard("1", "1_list", mappedTrelloLists));

        //When

        trelloValidator.validateCard(trelloCard);
        List<TrelloBoard> result = trelloValidator.validateTrelloBoards(mappedTrelloBoards);
        //Then
